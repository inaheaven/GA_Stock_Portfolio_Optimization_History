...
def save_test_generation(best_chromosome, year, month, test_genes, test_roi, test_risk, test_fitness):
    monthly_best_file_name = "Kospi_200_portfolio_optimization-Monthly Best.csv"
    best = []
    genes_title = "Genes"
    ...
    writer = csv.writer(
        open('../result/' + str(year) + "/" + str(month) + '/' + monthly_best_file_name, 'a', newline=''))
