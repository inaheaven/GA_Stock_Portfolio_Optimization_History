...
def test_best_population(best_chromosome, test_day_list, test_stock_price_list, year, month, test_start_date, test_end_date, ga_start_date, ga_end_date):
    ...
    save.save_test_generation(best_chromosome, year, month, test_genes, test_roi, test_risk, test_fitness)
