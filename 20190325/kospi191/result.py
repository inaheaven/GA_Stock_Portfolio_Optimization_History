...
def save_best_generation(best_chromosome, year, month, monthly_best_file_name):
    ...
    monthly_best.append([year, month, ":", monthly_best_genes_title, best_chromosome.get_genes(), monthly_best_fitness_title, best_chromosome.get_fitness(), monthly_best_roi_title, best_chromosome.get_rois()])
