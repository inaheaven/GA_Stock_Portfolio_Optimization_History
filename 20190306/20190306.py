...
ENDDATE = datetime.datetime(2018, 1, 2)
...
class Chromosome:
    ...
    def __init__(self):
        ...
        self._stock_price = fund_standardization.stock_prices(self._genes, self._day, KOSPI_TICKER, STARTDATE, ENDDATE)
