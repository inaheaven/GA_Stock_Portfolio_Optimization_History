...
def multiple_quarter(year_index):
    ...
    for month_index in range(1, MONTHS, 1):
        ...
        ga_end_date = ga_start_date + relativedelta.relativedelta(months=1)
