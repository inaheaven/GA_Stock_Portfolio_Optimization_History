...
def test_best_population(best_chromosome, test_day_list, test_stock_price_list, test_start_date, test_end_date):
    ...
    save.print_test_population(test_start_date, test_end_date, test_genes, test_num_of_selected_stocks, test_roi, test_risk, test_fitness)
