...
def main(year, month, ga_start_date, ga_end_date, test_start_date, test_end_date, index):
    ...
    save.save_population(population, 0, year, month)
    generation_number = 1
    ...
    if generation_number == GENERATION_SIZE:
        ...
        save.save_best_generation(best_chromosome, year, month)
        test_fund.test_best_population(best_chromosome, test_day_list, test_stock_price_list, ga_start_date, ga_end_date, test_start_date, test_end_date)
