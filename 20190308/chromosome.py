...
ENDDATE = datetime.datetime(2018, 1, 3)
NUM_OF_STOCKS = len(KOSPI_TICKER)
FEE_RATE = 0.000015
TAX_RATE = 0.003
RISK_FREE_RATE = 0.02
INITIAL_FUNDS = 100000000
STOCK_SELCTION_RATE = 0.25
...
class Chromosome:
    ...
    def __init__(self):
        ...
        _stock_price = fund_standardization.stock_prices(self._genes, _day, KOSPI_TICKER)
        ...
        self._fitness = fund_standardization.fitnesses(_roi, _risk, RISK_FREE_RATE)
